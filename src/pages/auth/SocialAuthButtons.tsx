...
const SocialAuthButtons: React.FC<Props> = ({ loading, setLoading, onTelegram }) => {
  ...
  return (
    <div className="space-y-3">
      ...
      <Button type="button" variant="outline"
        ...
        onClick={onTelegram} disabled={loading}>
        <Send className="w-5 h-5 mr-2" />Continue with Telegram
      </Button>
    </div>
  );
};
